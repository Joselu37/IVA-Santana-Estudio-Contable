...
function serveStatic(req, res) {
  ...
  fs.readFile(filePath, (error, content) => {
    if (error) {
      ...
      // Evita que el navegador sirva versiones viejas en caché de los archivos de
      // la app (muy común confundirlo con "el fix no funcionó" cuando en realidad
      // se sigue ejecutando JS/CSS anterior). Los assets estáticos pesados
      // (imágenes, íconos) sí pueden cachearse sin problema.
